                ...
                <div>
                    ...
                    <div className="absolute right-[10%] -mt-[5.2rem] max-[1023px]:right-[2%] max-[617px]:left-0 max-[617px]:mt-24 ">
                        <ul className="max-[781px]:ml-[2.5rem] ">
                            ...
                            <li><a href="/home" className="hover:text-gray-900 text-[18px] font-[400] font-poppins leading-[35px] max-[781px]:text-[12px]">Home</a></li>
                            <li><a href="/itemSerch" className="hover:text-gray-900 text-[18px] font-[400] font-poppins leading-[35px] max-[781px]:text-[12px]">Products</a></li>
                            <li><a href="/home" className="hover:text-gray-900 text-[18px] fonr-[400] font-poppins leading-[35px] max-[781px]:text-[12px]">About Us</a></li>
                            <li><a href="/contactUs" className="hover:text-gray-900 text-[18px] font-[400] font-poppins leading-[35px] max-[781px]:text-[12px]">Contact Us</a></li>
                        </ul>
